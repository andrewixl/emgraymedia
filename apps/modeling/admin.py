...
from .models import Album, Picture, Home, Contact, Package, About, Navbar, Promotion, ContactPage, Booking
...
class AlbumAdmin(admin.ModelAdmin):
    save_on_top = True
    fields = ["album_name", "album_cover", "album_location", "album_description", "album_photographer", "album_model", "shoot_date", "album_type",]
